...
Pocket Money is available under a **dual license**:
...
Use of this software for any commercial purpose—including but not limited to:

- Use in a for-profit product or service
- Use in production by a business or organization that is not covered under the non-commercial terms (e.g. not a charity, educational institution, or government body)
- Redistribution or resale of the software or a derivative
- Use as part of a paid offering (SaaS, hosted service, etc.)
